...
const language_tag_completions = blk: {
    var comps: [language_codes.len]Ast.Completion = undefined;
    for (language_codes, &comps) |code, *completion| {
        completion.* = .{
            .label = code.two,
            .desc = code.name,
        };
...
const language_script_completions = blk: {
    var comps: [language_scripts.len]Ast.Completion = undefined;
    for (language_scripts, &comps) |script, *completion| {
        completion.* = .{
            .label = script.code,
            .desc = script.name,
        };
...
const language_codes = .{
    .{ .three = "aar", .two = "aa", .name = "Afar" },
    .{ .three = "abk", .two = "ab", .name = "Abkhazian" },
    .{ .three = "afr", .two = "af", .name = "Afrikaans" },
    .{ .three = "aka", .two = "ak", .name = "Akan" },
    .{ .three = "alb", .two = "sq", .name = "Albanian" },
    .{ .three = "amh", .two = "am", .name = "Amharic" },
    .{ .three = "ara", .two = "ar", .name = "Arabic" },
    .{ .three = "arg", .two = "an", .name = "Aragonese" },
    .{ .three = "arm", .two = "hy", .name = "Armenian" },
    .{ .three = "asm", .two = "as", .name = "Assamese" },
    .{ .three = "ava", .two = "av", .name = "Avaric" },
    .{ .three = "ave", .two = "ae", .name = "Avestan" },
    .{ .three = "aym", .two = "ay", .name = "Aymara" },
    .{ .three = "aze", .two = "az", .name = "Azerbaijani" },
    .{ .three = "bak", .two = "ba", .name = "Bashkir" },
    .{ .three = "bam", .two = "bm", .name = "Bambara" },
    .{ .three = "baq", .two = "eu", .name = "Basque" },
    .{ .three = "bel", .two = "be", .name = "Belarusian" },
    .{ .three = "ben", .two = "bn", .name = "Bengali" },
    .{ .three = "bis", .two = "bi", .name = "Bislama" },
    .{ .three = "bos", .two = "bs", .name = "Bosnian" },
    .{ .three = "bre", .two = "br", .name = "Breton" },
    .{ .three = "bul", .two = "bg", .name = "Bulgarian" },
    .{ .three = "bur", .two = "my", .name = "Burmese" },
    .{ .three = "cat", .two = "ca", .name = "Catalan; Valencian" },
    .{ .three = "cha", .two = "ch", .name = "Chamorro" },
    .{ .three = "che", .two = "ce", .name = "Chechen" },
    .{ .three = "chi", .two = "zh", .name = "Chinese" },
    .{ .three = "chu", .two = "cu", .name = "Church Slavic; Old Slavonic; Church Slavonic; Old Bulgarian; Old Church Slavonic" },
    .{ .three = "chv", .two = "cv", .name = "Chuvash" },
    .{ .three = "cor", .two = "kw", .name = "Cornish" },
    .{ .three = "cos", .two = "co", .name = "Corsican" },
    .{ .three = "cre", .two = "cr", .name = "Cree" },
    .{ .three = "cze", .two = "cs", .name = "Czech" },
    .{ .three = "dan", .two = "da", .name = "Danish" },
    .{ .three = "div", .two = "dv", .name = "Divehi; Dhivehi; Maldivian" },
    .{ .three = "dut", .two = "nl", .name = "Dutch; Flemish" },
    .{ .three = "dzo", .two = "dz", .name = "Dzongkha" },
    .{ .three = "eng", .two = "en", .name = "English" },
    .{ .three = "epo", .two = "eo", .name = "Esperanto" },
    .{ .three = "est", .two = "et", .name = "Estonian" },
    .{ .three = "ewe", .two = "ee", .name = "Ewe" },
    .{ .three = "fao", .two = "fo", .name = "Faroese" },
    .{ .three = "fij", .two = "fj", .name = "Fijian" },
    .{ .three = "fin", .two = "fi", .name = "Finnish" },
    .{ .three = "fre", .two = "fr", .name = "French" },
    .{ .three = "fry", .two = "fy", .name = "Western Frisian" },
    .{ .three = "ful", .two = "ff", .name = "Fulah" },
    .{ .three = "geo", .two = "ka", .name = "Georgian" },
    .{ .three = "ger", .two = "de", .name = "German" },
    .{ .three = "gla", .two = "gd", .name = "Gaelic; Scottish Gaelic" },
    .{ .three = "gle", .two = "ga", .name = "Irish" },
    .{ .three = "glg", .two = "gl", .name = "Galician" },
    .{ .three = "glv", .two = "gv", .name = "Manx" },
    .{ .three = "gre", .two = "el", .name = "Greek, Modern (1453-)" },
    .{ .three = "grn", .two = "gn", .name = "Guarani" },
    .{ .three = "guj", .two = "gu", .name = "Gujarati" },
    .{ .three = "hat", .two = "ht", .name = "Haitian; Haitian Creole" },
    .{ .three = "hau", .two = "ha", .name = "Hausa" },
    .{ .three = "heb", .two = "he", .name = "Hebrew" },
    .{ .three = "her", .two = "hz", .name = "Herero" },
    .{ .three = "hin", .two = "hi", .name = "Hindi" },
    .{ .three = "hmo", .two = "ho", .name = "Hiri Motu" },
    .{ .three = "hrv", .two = "hr", .name = "Croatian" },
    .{ .three = "hun", .two = "hu", .name = "Hungarian" },
    .{ .three = "ibo", .two = "ig", .name = "Igbo" },
    .{ .three = "ice", .two = "is", .name = "Icelandic" },
    .{ .three = "ido", .two = "io", .name = "Ido" },
    .{ .three = "iii", .two = "ii", .name = "Sichuan Yi; Nuosu" },
    .{ .three = "iku", .two = "iu", .name = "Inuktitut" },
    .{ .three = "ile", .two = "ie", .name = "Interlingue; Occidental" },
    .{ .three = "ina", .two = "ia", .name = "Interlingua (International Auxiliary Language Association)" },
    .{ .three = "ind", .two = "id", .name = "Indonesian" },
    .{ .three = "ipk", .two = "ik", .name = "Inupiaq" },
    .{ .three = "ita", .two = "it", .name = "Italian" },
    .{ .three = "jav", .two = "jv", .name = "Javanese" },
    .{ .three = "jpn", .two = "ja", .name = "Japanese" },
    .{ .three = "kal", .two = "kl", .name = "Kalaallisut; Greenlandic" },
    .{ .three = "kan", .two = "kn", .name = "Kannada" },
    .{ .three = "kas", .two = "ks", .name = "Kashmiri" },
    .{ .three = "kau", .two = "kr", .name = "Kanuri" },
    .{ .three = "kaz", .two = "kk", .name = "Kazakh" },
    .{ .three = "khm", .two = "km", .name = "Central Khmer" },
    .{ .three = "kik", .two = "ki", .name = "Kikuyu; Gikuyu" },
    .{ .three = "kin", .two = "rw", .name = "Kinyarwanda" },
    .{ .three = "kir", .two = "ky", .name = "Kirghiz; Kyrgyz" },
    .{ .three = "kom", .two = "kv", .name = "Komi" },
    .{ .three = "kon", .two = "kg", .name = "Kongo" },
    .{ .three = "kor", .two = "ko", .name = "Korean" },
    .{ .three = "kua", .two = "kj", .name = "Kuanyama; Kwanyama" },
    .{ .three = "kur", .two = "ku", .name = "Kurdish" },
    .{ .three = "lao", .two = "lo", .name = "Lao" },
    .{ .three = "lat", .two = "la", .name = "Latin" },
    .{ .three = "lav", .two = "lv", .name = "Latvian" },
    .{ .three = "lim", .two = "li", .name = "Limburgan; Limburger; Limburgish" },
    .{ .three = "lin", .two = "ln", .name = "Lingala" },
    .{ .three = "lit", .two = "lt", .name = "Lithuanian" },
    .{ .three = "ltz", .two = "lb", .name = "Luxembourgish; Letzeburgesch" },
    .{ .three = "lub", .two = "lu", .name = "Luba-Katanga" },
    .{ .three = "lug", .two = "lg", .name = "Ganda" },
    .{ .three = "mac", .two = "mk", .name = "Macedonian" },
    .{ .three = "mah", .two = "mh", .name = "Marshallese" },
    .{ .three = "mal", .two = "ml", .name = "Malayalam" },
    .{ .three = "mao", .two = "mi", .name = "Maori" },
    .{ .three = "mar", .two = "mr", .name = "Marathi" },
    .{ .three = "may", .two = "ms", .name = "Malay" },
    .{ .three = "mlg", .two = "mg", .name = "Malagasy" },
    .{ .three = "mlt", .two = "mt", .name = "Maltese" },
    .{ .three = "mon", .two = "mn", .name = "Mongolian" },
    .{ .three = "nau", .two = "na", .name = "Nauru" },
    .{ .three = "nav", .two = "nv", .name = "Navajo; Navaho" },
    .{ .three = "nbl", .two = "nr", .name = "Ndebele, South; South Ndebele" },
    .{ .three = "nde", .two = "nd", .name = "Ndebele, North; North Ndebele" },
    .{ .three = "ndo", .two = "ng", .name = "Ndonga" },
    .{ .three = "nep", .two = "ne", .name = "Nepali" },
    .{ .three = "nno", .two = "nn", .name = "Norwegian Nynorsk; Nynorsk, Norwegian" },
    .{ .three = "nob", .two = "nb", .name = "BokmÃ¥l, Norwegian; Norwegian BokmÃ¥l" },
    .{ .three = "nor", .two = "no", .name = "Norwegian" },
    .{ .three = "nya", .two = "ny", .name = "Chichewa; Chewa; Nyanja" },
    .{ .three = "oci", .two = "oc", .name = "Occitan (post 1500)" },
    .{ .three = "oji", .two = "oj", .name = "Ojibwa" },
    .{ .three = "ori", .two = "or", .name = "Oriya" },
    .{ .three = "orm", .two = "om", .name = "Oromo" },
    .{ .three = "oss", .two = "os", .name = "Ossetian; Ossetic" },
    .{ .three = "pan", .two = "pa", .name = "Panjabi; Punjabi" },
    .{ .three = "per", .two = "fa", .name = "Persian" },
    .{ .three = "pli", .two = "pi", .name = "Pali" },
    .{ .three = "pol", .two = "pl", .name = "Polish" },
    .{ .three = "por", .two = "pt", .name = "Portuguese" },
    .{ .three = "pus", .two = "ps", .name = "Pushto; Pashto" },
    .{ .three = "que", .two = "qu", .name = "Quechua" },
    .{ .three = "roh", .two = "rm", .name = "Romansh" },
    .{ .three = "rum", .two = "ro", .name = "Romanian; Moldavian; Moldovan" },
    .{ .three = "run", .two = "rn", .name = "Rundi" },
    .{ .three = "rus", .two = "ru", .name = "Russian" },
    .{ .three = "sag", .two = "sg", .name = "Sango" },
    .{ .three = "san", .two = "sa", .name = "Sanskrit" },
    .{ .three = "sin", .two = "si", .name = "Sinhala; Sinhalese" },
    .{ .three = "slo", .two = "sk", .name = "Slovak" },
    .{ .three = "slv", .two = "sl", .name = "Slovenian" },
    .{ .three = "sme", .two = "se", .name = "Northern Sami" },
    .{ .three = "smo", .two = "sm", .name = "Samoan" },
    .{ .three = "sna", .two = "sn", .name = "Shona" },
    .{ .three = "snd", .two = "sd", .name = "Sindhi" },
    .{ .three = "som", .two = "so", .name = "Somali" },
    .{ .three = "sot", .two = "st", .name = "Sotho, Southern" },
    .{ .three = "spa", .two = "es", .name = "Spanish; Castilian" },
    .{ .three = "srd", .two = "sc", .name = "Sardinian" },
    .{ .three = "srp", .two = "sr", .name = "Serbian" },
    .{ .three = "ssw", .two = "ss", .name = "Swati" },
    .{ .three = "sun", .two = "su", .name = "Sundanese" },
    .{ .three = "swa", .two = "sw", .name = "Swahili" },
    .{ .three = "swe", .two = "sv", .name = "Swedish" },
    .{ .three = "tah", .two = "ty", .name = "Tahitian" },
    .{ .three = "tam", .two = "ta", .name = "Tamil" },
    .{ .three = "tat", .two = "tt", .name = "Tatar" },
    .{ .three = "tel", .two = "te", .name = "Telugu" },
    .{ .three = "tgk", .two = "tg", .name = "Tajik" },
    .{ .three = "tgl", .two = "tl", .name = "Tagalog" },
    .{ .three = "tha", .two = "th", .name = "Thai" },
    .{ .three = "tib", .two = "bo", .name = "Tibetan" },
    .{ .three = "tir", .two = "ti", .name = "Tigrinya" },
    .{ .three = "ton", .two = "to", .name = "Tonga (Tonga Islands)" },
    .{ .three = "tsn", .two = "tn", .name = "Tswana" },
    .{ .three = "tso", .two = "ts", .name = "Tsonga" },
    .{ .three = "tuk", .two = "tk", .name = "Turkmen" },
    .{ .three = "tur", .two = "tr", .name = "Turkish" },
    .{ .three = "twi", .two = "tw", .name = "Twi" },
    .{ .three = "uig", .two = "ug", .name = "Uighur; Uyghur" },
    .{ .three = "ukr", .two = "uk", .name = "Ukrainian" },
    .{ .three = "urd", .two = "ur", .name = "Urdu" },
    .{ .three = "uzb", .two = "uz", .name = "Uzbek" },
    .{ .three = "ven", .two = "ve", .name = "Venda" },
    .{ .three = "vie", .two = "vi", .name = "Vietnamese" },
    .{ .three = "vol", .two = "vo", .name = "Volapük" },
    .{ .three = "wel", .two = "cy", .name = "Welsh" },
    .{ .three = "wln", .two = "wa", .name = "Walloon" },
    .{ .three = "wol", .two = "wo", .name = "Wolof" },
    .{ .three = "xho", .two = "xh", .name = "Xhosa" },
    .{ .three = "yid", .two = "yi", .name = "Yiddish" },
    .{ .three = "yor", .two = "yo", .name = "Yoruba" },
    .{ .three = "zha", .two = "za", .name = "Zhuang; Chuang" },
    .{ .three = "zul", .two = "zu", .name = "Zulu" },
};
                ...
                switch (attr_model.rule) {
                    ...
                    .lang => {
                        if (value_content.len == 0) {
                            return &language_tag_completions;
                        }
